                                    ...
                                    <div class="card-body">
                                        <form id="formLogin">
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <button class="btn btn-primary" type="submit" onclick="formLogin(event);">Login</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Bienvenido a mi pagina web (Sistema de Venta de Computadoras) <a href="https://www.facebook.com/" target="_blank" rel="eefe"></a> <?php echo date("Y") ?></div>
                            <div>
